...
namespace CosmosGettingStartedTutorial
{
    class Program
    {
        ...
        public async Task GetStartedDemoAsync()
        {
            ...
            Console.WriteLine("CreateDatabaseAsync - Press any key to continue.");
            Console.ReadKey();
            await this.CreateContainerAsync();
            Console.WriteLine("CreateContainerAsync - Press any key to continue.");
            Console.ReadKey();
            await this.ScaleContainerAsync();
            Console.WriteLine("ScaleContainerAsync - Press any key to continue.");
            Console.ReadKey();
            await this.AddItemsToContainerAsync();
            Console.WriteLine("AddItemsToContainerAsync - Press any key to continue.");
            Console.ReadKey();
            await this.QueryItemsAsync();
            Console.WriteLine("QueryItemsAsync - Press any key to continue.");
            Console.ReadKey();
            await this.ReplaceFamilyItemAsync();
            Console.WriteLine("ReplaceFamilyItemAsync - Press any key to continue.");
            Console.ReadKey();
            await this.DeleteFamilyItemAsync();
            Console.WriteLine("DeleteFamilyItemAsync - Press any key to continue.");
            Console.ReadKey();
            await this.DeleteDatabaseAndCleanupAsync();
            Console.WriteLine("DeleteDatabaseAndCleanupAsync - Press any key to continue.");
            Console.ReadKey();
        }
        // </GetStartedDemoAsync>
